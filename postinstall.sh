...
# ## Finalize
# rm -v ~/.bash_*
# printf "\nThe installation finished succesfully. Install the appropriate graphics drivers and reboot the machine to get started.\n\n"
